...
\item
  ...
  \index{GitHub repository of notebooks}
...
\item
  ...
  \index{webpages of rendered notebooks}
...
\[q_t + (uq)_x = 0.\]
\index{flux function!for advection equation}
...
\end{align*}\\
\index{flux function!for acoustics equations}
...
\index{flux function!for traffic flow}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.99\linewidth}{0.9\paperheight}}{combined_files/combined_177_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.99\linewidth}{0.9\paperheight}}{combined_files/combined_179_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.99\linewidth}{0.9\paperheight}}{combined_files/combined_182_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.99\linewidth}{0.9\paperheight}}{combined_files/combined_185_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.99\linewidth}{0.9\paperheight}}{combined_files/combined_188_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.99\linewidth}{0.99\paperheight}}{combined_files/combined_190_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.99\linewidth}{0.9\paperheight}}{combined_files/combined_192_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.99\linewidth}{0.9\paperheight}}{combined_files/combined_194_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.99\linewidth}{0.9\paperheight}}{combined_files/combined_196_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.7\linewidth}{0.7\paperheight}}{combined_files/combined_246_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.7\linewidth}{0.7\paperheight}}{combined_files/combined_246_1.pdf}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.7\linewidth}{0.7\paperheight}}{combined_files/combined_246_2.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.7\linewidth}{0.7\paperheight}}{combined_files/combined_248_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.7\linewidth}{0.7\paperheight}}{combined_files/combined_248_1.pdf}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.7\linewidth}{0.7\paperheight}}{combined_files/combined_248_2.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\index{advection equation!color equation}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.7\linewidth}{0.7\paperheight}}{combined_files/combined_260_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.7\linewidth}{0.7\paperheight}}{combined_files/combined_260_1.pdf}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.7\linewidth}{0.7\paperheight}}{combined_files/combined_260_2.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\index{pressure!in gas dynamics}
...
\end{align}\\
\index{nonlinear conservation law}
\index{flux function!for Euler equations}
...
\hreffoot{https://github.com/clawpack/riemann/blob/master/src/rp1_shallow_roe_with_efix.f90}{here}.
\index{Clawpack}
...
An implementation of this solver for use in Clawpack can be found
\index{Clawpack}
\hreffoot{https://github.com/clawpack/riemann/blob/master/src/rp1_shallow_hlle.f90}{here}.
...
An implementation of this solver for use in Clawpack can be found
\index{Clawpack}
\hreffoot{https://github.com/clawpack/riemann/blob/master/src/rp1_euler_with_efix.f90}{here}.
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.7\linewidth}{0.7\paperheight}}{combined_files/combined_433_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.7\linewidth}{0.7\paperheight}}{combined_files/combined_434_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.7\linewidth}{0.7\paperheight}}{combined_files/combined_437_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.7\linewidth}{0.7\paperheight}}{combined_files/combined_438_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.7\linewidth}{0.7\paperheight}}{combined_files/combined_440_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.7\linewidth}{0.7\paperheight}}{combined_files/combined_441_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.7\linewidth}{0.7\paperheight}}{combined_files/combined_444_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.7\linewidth}{0.7\paperheight}}{combined_files/combined_449_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.7\linewidth}{0.7\paperheight}}{combined_files/combined_450_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.6\linewidth}{0.6\paperheight}}{combined_files/combined_452_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.7\linewidth}{0.7\paperheight}}{combined_files/combined_454_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
{\color{incolor}In [{\color{incolor}9}]:} \PY{n}{N} \PY{o}{=} \PY{l+m+mi}{400}  \PY{c+c1}{\PYZsh{} number of grid cells to use}
        ...
        \PY{n}{interact}\PY{p}{(}\PY{n}{plot\PYZus{}frame}\PY{p}{,} \PY{n}{i}\PY{o}{=}\PY{n}{widgets}\PY{o}{.}\PY{n}{IntSlider}\PY{p}{(}\PY{n+nb}{min}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{,} \PY{n+nb}{max}\PY{o}{=}\PY{l+m+mi}{30}\PY{p}{,} \PY{n}{value}\PY{o}{=}\PY{l+m+mi}{15}\PY{p}{,} 
            \PY{n}{description}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Frame}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}\PY{p}{;}
\end{Verbatim}
