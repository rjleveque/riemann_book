...
{\color{outcolor}Out[{\color{outcolor}8}]:} <IPython.lib.display.IFrame at 0x11d564630>
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}9}]:} <IPython.lib.display.IFrame at 0x11d564470>
\end{Verbatim}
